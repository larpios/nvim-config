local arts = require('larpi.plugins.startscreen.arts')
local random_art = larpi.fn.tbl_choose_random(arts)[1]
...
local function limit_size(art_lines, max_width, max_height)
    ...
    for i, line in ipairs(new_lines) do
        ...
        local line_length = larpi.fn.utf8_len(line)
        if line_length > max_width then
            ...
            new_lines[i] = larpi.fn.utf8_sub(line, start_col, end_col)
        end
    end
