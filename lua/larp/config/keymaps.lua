...
-- General
vim.keymap.set({ 'n', 'x' }, '<leader>qq', ':confirm qa<cr>', { desc = 'Exit NeoVim', noremap = true, silent = true })
vim.keymap.set({ 'n', 'x' }, '<leader>QQ', ':qa!<cr>', { desc = 'Exit NeoVim without saving', noremap = true, silent = true })
